...
for loopIdx = 1:numRuns
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_contentfdi_conservative_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_contentfdi_conservative_%d.csv', loopIdx));
