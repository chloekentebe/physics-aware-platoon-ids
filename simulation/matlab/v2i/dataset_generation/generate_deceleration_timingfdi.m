...
for loopIdx = 1:numRuns
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_timingfdi_deceleration_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_timingfdi_deceleration_%d.csv', loopIdx));
