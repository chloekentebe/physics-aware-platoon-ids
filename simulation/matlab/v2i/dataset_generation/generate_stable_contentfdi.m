...
for loopIdx = 1:numRuns
    ...
    scenarioHandle = @(p1, p2) stable_highway_scenario(p1, p2, currentLHS);
    ...
    T.Profile      = repmat("Stable_Highway", N, 1);
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_contentfdi_stable_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_contentfdi_stable_%d.csv', loopIdx));
