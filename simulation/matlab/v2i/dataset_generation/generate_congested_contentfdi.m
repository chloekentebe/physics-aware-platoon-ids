...
for loopIdx = 1:numRuns
    ...
    scenarioHandle = @(p1, p2) congested_highway_scenario(p1, p2, currentLHS);
    ...
    T.Profile      = repmat("Congested_Highway", N, 1);
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_contentfdi_congested_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_contentfdi_congested_%d.csv', loopIdx));
