...
for loopIdx = 1:numRuns
    ...
    scenarioHandle = @(param1, param2) deceleration_highway_scenario(param1, param2, currentLHS);
    ...
    platoonFile = fullfile( ...
        outPath, ...
        sprintf('platoon_run_%d.csv', loopIdx + 90));
    ...
    for b = 1:length(bsmSignalNames)
        ...
        try
            ...
            for slot = 1:5
                ...
                tempTable.RunID        = repmat(loopIdx + 90, M, 1);
    ...
    % SAVE BSM TABLE
    % =====================================================
    bsmFile = fullfile(outPath, sprintf('normal_deceleration_bsm_run_%d.csv', loopIdx));
