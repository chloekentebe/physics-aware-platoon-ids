function [initialActorPose,accelerationProfile,stopTime] = ...
    stable_highway_scenario( ...
    tractorTrailerParameters,vehicleDimension, currentLHS)

% =========================================================
% STABLE HIGHWAY PROFILE
%
% Target:
% Cruise Speed      ≈ 22 m/s
% Initial Spacing   ≈ 20 m
% Steady Spacing    ≈ 10 m
% =========================================================
...
% Gentle acceleration
ampValues = 0.10 + (0.20 - 0.10)*currentLHS(1,1);

% Cruise speed
velBases = 21.25 + (21.9 - 21.25)*currentLHS(1,2);

% Initial spacing
spacingBases = 18.0 + (22.0 - 18.0)*currentLHS(1,3);

% RSU guidance values

deltaSpeedUp1  =  0.07 + (0.17 - 0.07)*currentLHS(1,4);
deltaSpeedUp2  =  0.03 + (0.06 - 0.03)*currentLHS(1,5);
...
accelerationProfile.Amplitude = [ampValues 0 -1.0 0];
accelerationProfile.Period = 60;
accelerationProfile.PulseWidth = [4 4 15 40];
accelerationProfile.PhaseDelay = [1 5 9 25];
