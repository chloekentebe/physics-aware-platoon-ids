...
for loopIdx = 1:numRuns
    ...
    scenarioHandle = @(param1, param2) congested_highway_scenario(param1, param2, currentLHS);
    ...
    platoonFile = fullfile( ...
        outPath, ...
        sprintf('platoon_run_%d.csv', loopIdx + 60));
    ...
    for b = 1:length(bsmSignalNames)
        ...
        try
            ...
            for slot = 1:5
                ...
                tempTable.RunID        = repmat(loopIdx + 60, M, 1);
