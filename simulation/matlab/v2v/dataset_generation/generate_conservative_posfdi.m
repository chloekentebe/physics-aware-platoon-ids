...
for loopIdx = 1:numRuns
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_posfdi_conservative_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_posfdi_conservative_%d.csv', loopIdx));
