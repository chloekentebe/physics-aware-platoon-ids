...
for loopIdx = 1:numRuns
    ...
    attackTypeMap = containers.Map(...
        ...
        {0, 1, 2, 3, 4});
    attackTypeNum = attackTypeMap('SpeedFDI');
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_speedfdi_deceleration_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_speedfdi_deceleration_%d.csv', loopIdx));
