...
for loopIdx = 1:numRuns
    ...
    attackTypeMap = containers.Map(...
        ...
        {0, 1, 2, 3, 4});
    attackTypeNum = attackTypeMap('PosFDI');
    ...
    T.AttackType     = repmat("PosFDI",                     N, 1);
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_posfdi_deceleration_%d.csv', loopIdx));
    ...
    for b = 1:length(bsmSignals)
        ...
        try
            ...
            for slot = 1:5
                ...
                tempTable.AttackType   = repmat("PosFDI",                 M, 1);
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_posfdi_deceleration_%d.csv', loopIdx));
