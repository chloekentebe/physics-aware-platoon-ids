...
for loopIdx = 1:numRuns
    ...
    % SAVE PLATOON TABLE
    % =====================================================
    platoonFile = fullfile(outPath, sprintf('platoon_accfdi_conservative_%d.csv', loopIdx));
    ...
    bsmFile = fullfile(outPath, sprintf('bsm_accfdi_conservative_%d.csv', loopIdx));
